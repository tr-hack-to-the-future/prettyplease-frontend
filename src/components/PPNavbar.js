  ...
  function showUserTypeNavbar() {
    if (userType === "charity" && currentUser) {
      return (
        <div>
          <Nav>
            <Nav.Link href="/prettyplease-frontend/#/ForCharities">
              Charity Page
            </Nav.Link>
            <Nav.Link href="/prettyplease-frontend/#/NewFund">
              Raise Funds
            </Nav.Link>
            <Nav.Link href="/prettyplease-frontend/#/FundRequests">
              Fund Requests
            </Nav.Link>
            <Nav.Link href="/prettyplease-frontend/#/AcceptedOffers">
              Accepted Offers
            </Nav.Link>
          </Nav>
        </div>
      ...
      return (
        <div>
          <Nav>
            <Nav.Link href="/prettyplease-frontend/#/ForSponsors">
              Requests
            </Nav.Link>
            <Nav.Link href="/prettyplease-frontend/#/ForSponsorsPending">
              Offers Pending
            </Nav.Link>
            <Nav.Link href="/prettyplease-frontend/#/ForSponsorsAccepted">
              Offers Accepted
            </Nav.Link>
          </Nav>
        </div>
