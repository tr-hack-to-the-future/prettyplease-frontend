...
import SponsorshipRequestListing from './SponsorshipRequestListing';
    ...
    const [requests, setCharity] = useState([
        {
            ...
            // charityLogo: "./charity-logo-blue.png",
        ...
        },
        {
            ...
            // charityLogo: "./charity-logo-green.png",
            // sponsorship request description (TODO do we need an id value?)
            requestId: "2",
        ...
        <div className="SponsorPage">
            ...
            <Container md-6>
                ...
                <Row>
                    ...
                    <SponsorshipRequestListing requestData={requests} />
                    </CardDeck>
                </Row>
            </Container>
        </div>
