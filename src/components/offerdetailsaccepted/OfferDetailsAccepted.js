  ...
  return (
    <Container className="OfferDetailsAccepted">
      ...
      <Row className="pt-2 pb-2 justify-content-md-center">
        ...
        <Col className="text-center">
          Duration:{" "}
          {offer.durationInYears === 0
            ? "One-Off"
            : getFormattedDuration(offer.durationInYears)}
        </Col>
      </Row>
      ...
      <Row className="justify-content-md-center">
        You will be contacted by {offer.charityName} within the next seven days
        to finalise details of your sponsorship agreement.
      </Row>
      <Row className="row justify-content-center mt-5 lead">
        {offer.eventDescription}
      </Row>
      <Row className="row justify-content-center mt-2">{offer.incentive}</Row>
      <Router>
